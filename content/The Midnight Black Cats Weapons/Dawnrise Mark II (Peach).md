...
- **Effect**: (**A**) Peach dashes up to 10ft. in a straight line. You make a Melee Weapon Attack against each Creature you move though. On-Hit, Each creature takes 1d8(Slashing)+(Dex)+1d6(:FighterArts_light_element: [Radiant](https://solteria.org/Mechanics/Elemental-Combo-System#_fighterarts_light_element_-light-combos)) Damage.
  > (**Landing Burst**) (**B**) - When you finish this movement in an unoccupied space, all creatures within 5ft. of you must succeed a DC:14 Dexterity Saving Throw or take 3d6(Slashing)+3d4(:FighterArts_light_element: [Radiant](https://solteria.org/Mechanics/Elemental-Combo-System#_fighterarts_light_element_-light-combos)) Damage. Half Damage on a Pass. Peach can then make one Melee Weapon attack against a creature within 5ft. of her final position. 
...
- **Effect**: Peach envelopes herself in a Fey Mist. For the duration of the Art- Peach becomes [[Status Conditions (Crowd Control {CC})#**Ghosting**|Ghosted]], gains an additional 10ft of movement speed, and can reduce 1d8+(*Prof.Mod*) of Physical Damage.
  > Peach can also envelop her Allies in the Fey mist upon phasing through them, allowing them to also inherit the effects of this Art. 

(*Copy & Paste for Reduced Damage!*)
