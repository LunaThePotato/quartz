 {**Mithral Claws**}, Melee Weapon Attack, +9 to Hit, 5ft. Range, One Target.
...
### **Weapon Properties**
 ...
 - (:WeaponArts_piercing_strike: **Piercing Strike**) - As an bonus Action, you thrust your Claw into the enemy, on hit they must roll a DC: 15 Constitution Saving Throw and be inflicted with :Conditions_gaping_wounds: [[Status Conditions (Crowd Control {CC})#**Gaping-Wounds**|Gaping Wounds]] for 2 Turns.
...
- **Effect:** The Runic Glyphs of your Claws swiftly project an energy Barrier to an ally within range, interlocking with the enemy’s blow. The enemies' Melee Weapon Attack is made at −2 to hit; on a hit, reduce damage by 1d6 + Dex mod (Max: 5). 
...
- **Cost**: 4 Charges
- **Type**: Action
- **Effect**: The Runic Glyphs glow on your Claws You swing them in a 5ft Arc in front of you. Each Creature in that area must make an DC:15 Dexterity Saving Throw or take 2d8(*Slashing*)+(*Dex*)+1d12(:FighterArts_dark_element: [Necrotic](https://solteria.org/Mechanics/Elemental-Combo-System#-dark-combos)) damage and suffers any "On-Hit" effects you normally apply. On a Pass, they only take half the damage.
  > (**Momentum Spin**): If you moved at least 10ft straight immediately before using this art:
